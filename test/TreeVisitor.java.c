...
#define l ( this-> l )
#define r ( this-> r )
extern struct TreeVisitor_vtable TreeVisitor_vtable_;
extern struct TV_vtable TV_vtable_;
extern struct Tree_vtable Tree_vtable_;
extern struct Visitor_vtable Visitor_vtable_;
extern struct MyVisitor_vtable MyVisitor_vtable_;
  struct Tree * root;
  int ntb;
  int nti;
  struct MyVisitor * v;
